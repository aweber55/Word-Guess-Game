var wordBank = ["beef", "brisket", "bacon", "sausage", "steak", "chicken", "ribs", "pork", "ham", "sirloin", "filet", "ribeye", "hamburger"]
...
function finishGame() {
    ...
    if(chosenLtr.join(" ") === blanksSuccess.join(" ")) {
        winNumber++;
        alert("Winner, Winner, BBQ Dinner!!!!  Your word is " + guessingWord);
        ...
        alert("Not this Time, Buddy, you were looking for " + guessingWord + " try again!");
        startGame();
    }
}
